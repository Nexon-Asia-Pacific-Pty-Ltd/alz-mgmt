...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "nexon@masterton.com.au"

    # Resource group names
    management_resource_group_name = "masterton-rg-management-$${starter_location_01}"
    asc_export_resource_group_name = "masterton-rg-asc-export-$${starter_location_01}"
